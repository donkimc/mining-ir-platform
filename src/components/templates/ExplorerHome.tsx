...
/** Explorer homepage — brand-first full-viewport hero, thesis → highlights → flagship. */
export function ExplorerHome({ data, ticker }: TenantHomeProps) {
  const { company } = data

  return (
    <>
      <div className="hero-plane" data-template-region="explorer-hero">
        <SiteHeader companyName={company.displayName} tone="dark" variant="explorer" />
        <div
          id="main-content"
          tabIndex={-1}
      ...
      <section className="bg-[var(--paper)] py-20" data-template-region="explorer-thesis">
      ...
      <section className="bg-[var(--paper-deep)] py-20" data-template-region="explorer-highlights">
      ...
      <section
        className="bg-[var(--forest)] py-20 text-[var(--paper)]"
        data-template-region="explorer-flagship"
      >
      ...
      <section className="py-20" data-template-region="explorer-feed">
          ...
          <div>
            ...
            <div className="mt-10 border-t border-[color-mix(in_oklab,var(--ink)_12%,transparent)] pt-8">
              ...
              <p className="mt-4 text-[var(--ink-soft)]">
                Browse the <Link href="/documents">document library</Link> or{' '}
      ...
      <section
        className="bg-[var(--ink)] py-16 text-[var(--paper)]"
        data-template-region="explorer-contact"
      >
